...
def differential_evolution(converged, mutation = (0.5,1.0), P = 0.7, popSize = 10):
    ...
    def objective_fn(params):
        ...
        f = open(runFolder + "/modParameters" + str(count2) + ".dat", "w") # New param file numbered to run
        for line in lines:
            line = line.split(" ")
            varName = line[0]
        ...
        subprocess.call(["mv /home/schaeferj/models/convergence_lucy.dat " + runFolder, '/'], shell=True)
    ...
    while not converged(x, fx):
        ...
        F = open("/home/schaeferj/models/gen" + str(count) + "/result" + str(count) + ".dat", "w")
